...
def create_app():
    ...
    from .views import main_views , thumb_views, classfication_views, viewsPredict_views, beautiScore_views , similartly_views
    ...
    app.register_blueprint(beautiScore_views.bp)
